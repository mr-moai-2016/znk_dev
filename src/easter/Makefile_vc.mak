...
$(EXE_FILE2): $(OBJS2) 
	$(LINKER) /OUT:$(EXE_FILE2)  $(OBJS2) $(SUB_LIBS) $(MY_LIBS_ROOT)/libZnk/out_dir/$(ABINAME)/Znk-$(DL_VER).imp.lib $(MY_LIBS_ROOT)/libRano/out_dir/$(ABINAME)/Rano-$(DL_VER).imp.lib ws2_32.lib 
...
Est_unid.obj:
import_favorite.obj: Est_config.h Est_base.h Est_assort.h
